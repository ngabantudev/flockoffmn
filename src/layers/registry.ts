...
export const LAYERS: LayerDefinition[] = [
...

  {
    ...
    whatThisMeans: {
      en: 'Each record is an aircraft, not a person: identified by cross-referencing the FAA’s public ownership registry, then located hourly against adsb.lol, a keyless, volunteer-run ADS-B network that — unlike most flight trackers — does not honor requests to hide an aircraft from public display. Two of the agency categories we checked (MN State Patrol’s Aviation Section, MN DNR Enforcement Aviation) have aircraft registered directly to the agency; those records are confirmed ownership. The ice_air category is different in kind, not just source: ICE Air removal flights run on contracted commercial charter operators, not government-owned aircraft, so we match FAA ownership against Eastern Air Express and GlobalX — the two carriers reported as ICE’s primary current charter subcontractors under broker CSI Aviation. That only ever proves an aircraft belongs to one of those companies, never that a specific flight shown here is an active ICE mission — these are charter airlines that also fly unrelated commercial work, so ice_air records are marked "reported", not "confirmed". cbp is different again: a local spotter reference (Otter Goose, "Twin Cities Helicopters") ties one specific tail number, N3949A, to a CBP AS350 based at St. Paul Downtown Airport — matched here by tail number rather than owner name, since federal law-enforcement aircraft rarely register under the agency’s own name. The same source reports that CBP aircraft don’t usually reveal their position via ADS-B, so expect this record to be absent from the live positions most of the time even though the aircraft flies regularly. MN BCA, Minnesota county sheriff’s offices, and MN Army National Guard aviation have no FAA-registered aircraft findable under this method — the Guard specifically because military aircraft carry Army serial numbers, never FAA civil tail numbers, so no amount of registry matching could ever find them — and stay listed with zero records rather than removed, so each gap is visible. For specific flights volunteers have directly observed at MSP — including passenger counts and destinations — see the separate "Observed ICE Air flights" layer, which is sourced differently and carries its own, lower confidence.',
      es: 'Cada registro es una aeronave, no una persona: identificada mediante referencia cruzada con el registro público de propiedad de la FAA, y luego ubicada cada hora mediante adsb.lol, una red ADS-B voluntaria y sin clave que, a diferencia de la mayoría de los rastreadores de vuelos, no atiende solicitudes para ocultar una aeronave de la vista pública. Dos de las categorías de agencias que verificamos (la Sección de Aviación de la Patrulla Estatal de MN, la Aviación de Cumplimiento del DNR de MN) tienen aeronaves registradas directamente a nombre de la agencia; esos registros son de propiedad confirmada. La categoría ice_air es distinta, no solo en la fuente: los vuelos de remoción de ICE Air operan con transportistas chárter comerciales contratados, no aeronaves propiedad del gobierno, por lo que comparamos la propiedad registrada en la FAA con Eastern Air Express y GlobalX, las dos aerolíneas reportadas como principales subcontratistas actuales de ICE bajo el intermediario CSI Aviation. Eso solo demuestra que una aeronave pertenece a una de esas empresas, nunca que un vuelo específico mostrado aquí sea una misión activa de ICE — son aerolíneas chárter que también realizan trabajo comercial no relacionado, por lo que los registros ice_air se marcan como "reportado", no "confirmado". cbp es distinta otra vez: una referencia de un aficionado local (Otter Goose, "Twin Cities Helicopters") vincula un número de cola específico, N3949A, con un AS350 de CBP con base en el Aeropuerto St. Paul Downtown — identificado aquí por número de cola y no por nombre de propietario, ya que las aeronaves federales de aplicación de la ley rara vez se registran a nombre de la propia agencia. La misma fuente informa que las aeronaves de CBP normalmente no revelan su posición vía ADS-B, así que es de esperar que este registro esté ausente de las posiciones en vivo la mayor parte del tiempo aunque la aeronave vuele con regularidad. El BCA de MN, las oficinas de alguaciles de los condados de Minnesota y la aviación de la Guardia Nacional del Ejército de MN no tienen ninguna aeronave localizable mediante este método — la Guardia específicamente porque las aeronaves militares llevan números de serie del Ejército, nunca números de cola civiles de la FAA, por lo que ningún cruce de registros podría encontrarlas — y permanecen listadas con cero registros en lugar de eliminadas, para que cada brecha sea visible. Para vuelos específicos que voluntarios han observado directamente en MSP, incluidos números de pasajeros y destinos, vea la capa separada "Vuelos de ICE Air observados", que se origina de forma distinta y tiene su propia confianza, menor.',
    },
    limitations: [
      {
      ...
      {
        en: 'An ice_air record means the aircraft belongs to a company currently reported to hold an ICE Air charter subcontract — it does NOT mean the flight shown is an active deportation mission. These carriers fly non-ICE commercial charters too, and this layer cannot tell the two apart.',
        es: 'Un registro ice_air significa que la aeronave pertenece a una empresa reportada actualmente como titular de un subcontrato chárter de ICE Air; NO significa que el vuelo mostrado sea una misión de deportación activa. Estas aerolíneas también realizan chárteres comerciales no relacionados con ICE, y esta capa no puede distinguir entre ambos.',
      },
      {
        en: 'ice_air likely under-counts even the contractor fleets: most charter capacity is leased rather than owned outright by the operating brand, so aircraft flying real ICE Air missions may be registered to a lessor with no name resembling either company.',
        es: 'ice_air probablemente subestima incluso las flotas de los contratistas: la mayor parte de la capacidad chárter se arrienda en lugar de ser propiedad directa de la marca operadora, por lo que las aeronaves que realizan misiones reales de ICE Air pueden estar registradas a nombre de un arrendador sin ningún nombre parecido al de ninguna de las dos empresas.',
      },
      {
        en: 'MN BCA and county sheriff aviation currently have zero records — not because they were excluded, but because no FAA-registered aircraft was found under either name.',
      ...
      {
        en: 'mn_army_national_guard will always have zero records under this method: military aircraft carry Army serial numbers, not FAA civil tail numbers, so they cannot appear in the registry this layer matches against, and a local spotter reference reports they don’t reliably appear on ADS-B trackers either. Listed for reference, not as a claim that this layer can track it.',
        es: 'mn_army_national_guard siempre tendrá cero registros con este método: las aeronaves militares llevan números de serie del Ejército, no números de cola civiles de la FAA, por lo que no pueden aparecer en el registro con el que se compara esta capa, y una referencia de un aficionado local informa que tampoco aparecen de forma confiable en los rastreadores ADS-B. Se lista como referencia, no como una afirmación de que esta capa pueda rastrearla.',
      },
    ],
    geometry: 'point',
    color: '#eab308',
    ...
    categoryColors: {
      ...
      colors: [
        ...
        { value: 'cbp', color: '#f97316' },
        { value: 'mn_army_national_guard', color: '#84cc16' },
      ],
      fallback: '#94a3b8',
    },
    ...
    filters: [
      {
        ...
        valueDescriptions: {
          ...
          ice_air: {
            en: 'Owned by a current ICE Air charter subcontractor (not necessarily an active mission)',
            es: 'Propiedad de un subcontratista chárter actual de ICE Air (no necesariamente una misión activa)',
          },
          cbp: {
            en: 'US Customs and Border Protection (identified by tail number, not FAA owner name — rarely visible on ADS-B)',
            es: 'Oficina de Aduanas y Protección Fronteriza de EE. UU. (identificada por número de cola, no por nombre de propietario en la FAA — rara vez visible en ADS-B)',
          },
          mn_army_national_guard: {
            en: 'MN Army National Guard aviation (listed for reference; never appears here — see limitations)',
            es: 'Aviación de la Guardia Nacional del Ejército de MN (listada como referencia; nunca aparece aquí — ver limitaciones)',
          },
        },
      },
      {
        key: 'inMinnesota',
        kind: 'enum',
        label: { en: 'Currently in Minnesota', es: 'Actualmente en Minnesota' },
        valueDescriptions: {
          true: { en: 'Inside a Minnesota county right now', es: 'Dentro de un condado de Minnesota en este momento' },
          false: { en: 'Elsewhere in the country right now', es: 'En otro lugar del país en este momento' },
        },
      },
    ],
    detailFields: [
      ...
      { key: 'inMinnesota', label: { en: 'Currently in Minnesota', es: 'Actualmente en Minnesota' } },
      {
        key: 'observedFlightDates',
        label: { en: 'Directly observed on these ICE Air flights', es: 'Observado directamente en estos vuelos de ICE Air' },
      },
    ],
  },

  {
    id: 'observed_ice_flight',
    slug: 'observed-ice-flights',
    category: 'enforcement',
    order: 11,
    label: {
      en: 'Observed ICE Air flights',
      es: 'Vuelos de ICE Air observados',
    },
    summary: {
      en: 'Specific ICE Air removal flights volunteers have directly observed at MSP airport — who, how many, and where they were told the flight was headed.',
      es: 'Vuelos de remoción de ICE Air específicos que voluntarios han observado directamente en el aeropuerto MSP: qué avión, cuántas personas, y a dónde se dijo que se dirigía el vuelo.',
    },
    whatThisMeans: {
      en: 'No agency publishes a manifest for an ICE Air charter flight. What exists instead is volunteer observation: Minnesota 50501 stations observers near MSP who log which aircraft board, roughly how many people, and the destination as reported at the time — work KSTP and NPR have both covered independently. Each record here is a specific, dated flight, not a live position and not a government record. It is eyewitness testimony, transcribed from the compiler’s own log with attribution, and confidence is marked "reported" on every record for that reason. A flight not listed here does not mean it did not happen — only that no observer logged it.',
      es: 'Ninguna agencia publica un manifiesto de un vuelo chárter de ICE Air. Lo que existe en su lugar es observación voluntaria: Minnesota 50501 ubica observadores cerca de MSP que registran qué aeronave aborda, aproximadamente cuántas personas, y el destino según se informó en su momento — trabajo que KSTP y NPR han cubierto de forma independiente. Cada registro aquí es un vuelo específico y fechado, no una posición en vivo ni un registro gubernamental. Es un testimonio ocular, transcrito del registro del compilador con atribución, y la confianza se marca como "reportado" en cada registro por esa razón. Que un vuelo no aparezca aquí no significa que no haya ocurrido, solo que ningún observador lo registró.',
    },
    limitations: [
      {
        en: 'Eyewitness-sourced, not government-confirmed. Passenger counts and destinations are as reported by observers, not verified against any official manifest.',
        es: 'De origen ocular, no confirmado por el gobierno. Los números de pasajeros y los destinos son los reportados por los observadores, no verificados contra ningún manifiesto oficial.',
      },
      {
        en: 'Every record is pinned to MSP airport itself — the observation location — not a drawn flight path. The destination shown is text as reported, not a verified route.',
        es: 'Cada registro está anclado en el propio aeropuerto MSP, el lugar de observación, no en una ruta de vuelo trazada. El destino mostrado es texto tal como se reportó, no una ruta verificada.',
      },
      {
        en: 'This log is updated by hand from a source with no stable public API, so there is a lag between a flight happening and its appearance here. The compiler believes the log is complete back to 2025-10-01, but that is their own assessment, not a guarantee.',
        es: 'Este registro se actualiza a mano a partir de una fuente sin API pública estable, por lo que hay un retraso entre que ocurre un vuelo y su aparición aquí. El compilador cree que el registro está completo desde el 2025-10-01, pero esa es su propia evaluación, no una garantía.',
      },
    ],
    geometry: 'point',
    color: '#e11d48',
    dataPath: '/data/observed-ice-flights.geojson',
    csvPath: '/data/observed-ice-flights.csv',
    provenance: {
      source: 'MN50501: MSP ICE Air Flights, compiled by Nick Benson',
      sourceUrl: 'https://airtable.com/appXo5spat4J3IQ9K/shrhjlIuy1V64gR4A/tbl4ZyyH4kmbsgDAw/viwrMDP3ciEuh3yXf',
      license: '"These data can be used by anyone; attribution \'Nick Benson, MN50501\' is appreciated." (stated on the base itself, not a formal license)',
      licenseUrl: null,
      attribution: 'Nick Benson, Minnesota 50501',
      sourceDate: null,
      lastUpdated: null,
      refresh: 'periodic',
    },
    filters: [
      { key: 'sourceDate', kind: 'dateRange', label: { en: 'Flight date', es: 'Fecha del vuelo' } },
    ],
    detailFields: [
      { key: 'tailNumber', label: { en: 'Aircraft', es: 'Aeronave' } },
      { key: 'reportedPassengerCount', label: { en: 'Reported passengers', es: 'Pasajeros reportados' } },
      { key: 'reportedDestinations', label: { en: 'Reported destination(s)', es: 'Destino(s) reportado(s)' } },
      { key: 'reportedBy', label: { en: 'Reported by', es: 'Reportado por' } },
      { key: 'sourceNote', label: { en: 'Observer note', es: 'Nota del observador' } },
    ],
  },
