...
export const es: Record<string, string> = {
  ...
  clearFilters: 'Restablecer capas y filtros',
  filtersCleared: 'Se borraron todas las capas y filtros',
  ofTotal: 'de',
  categoryLayersShown: '{n} de {m} capas mostradas',
  filterNone: 'Ninguna',
  filterAll: 'Todas',
  filterCategoryToggleLabel: 'Mostrar todas las capas de {category}',
  filterLayerToggleLabel: 'Mostrar {layer}',
  filterResetToDefault: 'Restablecer valores predeterminados',
  filterSearchValuesLabel: 'Buscar valores de {filter}',
  filterSearchValuesPlaceholder: 'Buscar valores',
  filterSearchValuesEmpty: 'Ningún valor llamado "{query}" en {filter}. Esta lista incluye todos los valores que esta capa registra para ese campo.',
  filterSearchLayersLabel: 'Buscar capas de {category}',
  filterSearchLayersPlaceholder: 'Buscar capas',
  filterSearchLayersEmpty: 'Ninguna capa llamada "{query}" en {category}.',
