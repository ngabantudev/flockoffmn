...
export const es: Record<string, string> = {
  ...
  flightLogKnownGaps:
    'Limitaciones conocidas: los avistamientos se capturan mediante consultas cada 10 minutos, por lo que una marca de tiempo puede estar desviada hasta ese margen, y una escala en tierra más corta que 10 minutos podría pasar completamente desapercibida. La identificación del aeropuerto es de mejor esfuerzo y solo para Minnesota — los avistamientos en otros lugares se registran con el campo de aeropuerto vacío en vez de una suposición. Una coincidencia de distintivo de llamada no es una confirmación de registro: los distintivos pueden reutilizarse, reasignarse o simplemente no transmitirse, y este filtro no puede distinguir entre esos casos.',
